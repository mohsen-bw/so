...
#UPDATE FOTO
               ...
               if msg.contentType == 1:
                 if msg._from in admin:
                        if Amid in settings["ARfoto"]:
                            path = ki.downloadObjectMsg(msg_id)
                            del settings["ARfoto"][Amid]
                            ki.updateProfilePicture(path)
                            ki.sendMessage(msg.to,"Foto berhasil dirubah")
                        elif Bmid in settings["ARfoto"]:
                            path = kk.downloadObjectMsg(msg_id)
                            del settings["ARfoto"][Bmid]
                            kk.updateProfilePicture(path)
                            kk.sendMessage(msg.to,"Foto berhasil dirubah")                           
                        elif Cmid in settings["ARfoto"]:
                            path = kc.downloadObjectMsg(msg_id)
                            del settings["ARfoto"][Cmid]
                            kc.updateProfilePicture(path)
                            kc.sendMessage(msg.to,"Foto berhasil dirubah")                          
                        elif Dmid in settings["ARfoto"]:
                            path = kb.downloadObjectMsg(msg_id)
                            del settings["ARfoto"][Dmid]
                            kb.updateProfilePicture(path)
                            kb.sendMessage(msg.to,"Foto berhasil dirubah")                           
                        elif Emid in Setmain["ARfoto"]:
                            path = kd.downloadObjectMsg(msg_id)
                            del settings["ARfoto"][Emid]
                            kd.updateProfilePicture(path)
                            kd.sendMessage(msg.to,"Foto berhasil dirubah")                            
                        elif Zmid in settings["ARfoto"]:
                            path = sw.downloadObjectMsg(msg_id)
                            del settings["ARfoto"][Zmid]
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                if settings["SpamInvite"] == True: md+="✴ Spaminvite ✔\n"
                                else: md+="✴ Spaminvite ✖\n"
                                ...
                                if msg.to in protectjoin: md+="✴ Protectinvite ✔\n"
                                else: md+="✴ Protecinvite ✖\n"
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "✴ID USER✴\n", "")
                               msg.contentType = 13
...
#===========BOT UPDATE============#
                        elif msg.text in ["Cipok","Tagall","Desah","Emuach","Assalamualaikum","Pagi","Siang","Sore","Malam","Tag","All"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
...
#===========KICKOUT============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                try:cl.inviteIntoGroup(to, ["u04e716d3a3ca15b79acb0f8e40ca9553"]);has = "OK"
                                except:has = "NOT"
                                try:cl.kickoutFromGroup(to, ["u04e716d3a3ca15b79acb0f8e40ca9553"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "sehat"
                                else:sil = "sakit"
                                ...
                                try:kb.inviteIntoGroup(to, ["u5363e49c9aee8a09cfc6443f23c61053"]);has = "OK"
                                except:has = "NOT"
                                try:kb.kickoutFromGroup(to, ["u5363e49c9aee8a09cfc6443f23c61053"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "sehat"
                                else:sil = "sakit"
                                if has1 == "OK":sil1 = "sehat"
                                ...
                                try:kd.inviteIntoGroup(to, ["u10edf1b1d7503a698fd2496a8d2ee6da"]);has = "OK"
                                except:has = "NOT"
                                try:kd.kickoutFromGroup(to, ["u10edf1b1d7503a698fd2496a8d2ee6da"]);has1 = "OK"
                                except:has1 = "NOT"
                                if has == "OK":sil = "sehat"
                                else:sil = "sakit"
                                if has1 == "OK":sil1 = "sehat"
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                             #   cl.sendMessage(msg.to, "HADIR")
                                ...
                                kd.sendMessage(msg.to, "HADIR SEMU")
